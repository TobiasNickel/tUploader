...
b+=this.uploads[d].total;return 0==a&&0==b?1:a/b},setAccept:function(a){g.setAttribute("accept",a);if(a)switch(a){case "imgage/*":this.acceptedFileExtensions=".jpg,.jpeg,.png,.gif,.tif,.bmp";break;case "audio/*":this.acceptedFileExtensions=".mp3,.mp4,.odd,.wav";break;default:this.acceptedFileExtensions=a}else this.acceptedFileExtensions=null},acceptedFileExtensions:null,input:g,uploads:[],varName:"files",autoDropareaElement:e,autoDroparea:!0};(function(a){a._events={};a.on=function(b,a){b=b.toLowerCase();
b in this._events||(this._events[b]=[]);-1===this._events[b].indexOf(a)&&this._events[b].push(a)};a.off=function(a,d){a?d?delete this._events[a][this._events[a].indexOf(d)]:delete this._events[a]:this._events={}};a.trigger=function(a,d){if(a&&this._events[a])for(var c=this._events[a].length;c--;)this._events[a][c](d)}})(c);return c}(document);